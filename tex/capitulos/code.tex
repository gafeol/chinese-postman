...
\begin{itemize}
    ...
    \item \texttt{floyd-warshall.cpp}
        ...
        Neste mesmo arquivo estão dispostas três implementações do método \texttt{floyd_warshall}, uma para grafos, outra para digrafos e a última para grafos mistos.
