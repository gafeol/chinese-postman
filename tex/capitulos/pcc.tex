...
\item[\textbf{4º}]  Um possível circuito euleriano $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \begin{proof}
        ...
        Sejam $C'_1, \dots, C'_l$ os circuitos eulerianos dessas componentes.
    ...
    \begin{proof}
        Como os conjuntos $M, U$ foram gerados resolvendo um problema de transporte, possuímos a garantia que eles são os multiconjuntos de menor custo que igualam o grau de entrada e saída de todos vértices de um grafo $G(V, A, E)$. 
        ...
        Como havíamos provado anteriormente que $C_+ - C_- > 0$, chegamos a uma contradição.
