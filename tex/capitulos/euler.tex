...
Quando tratamos de grafos direcionados (ou digrafos), é necessário refinar a noção de grau de um vértice:
...
\begin{proof} 
    ...
    Esse procedimento pode ser utilizado para encontrar um caminho entre quaisquer dois vértices a partir de $T$. 
...
Após percorrido o caminho $\{A, B, C, A\}$ as arestas $AB, BC, CA$ são apagadas e a busca não consegue progredir para novas arestas a partir do vértice $A$.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[auto,node distance=3cm, every loop/.style={},thick,main node/.style={circle,draw,font=\sffamily\Large}]
        ...
        \path[every node/.style={font=\sffamily\small}]
            ...
            ;
    \end{tikzpicture}
    \caption{Representam-se em negrito as arestas que ainda fazem parte da pilha de recursão da busca.}
\end{figure}
