...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \begin{proof}
        Como os conjuntos $M, U$ foram gerados resolvendo um problema de transporte, possuimos a garantia que eles são os multiconjuntos de menor custo que igualam o grau de entrada e saída de um grafo. 

        Portanto já podemos descartar a possibilidade de que $M', U'$ possui um custo menor que $M, U$. 
        Assumimos, por absurdo, que $M', U'$ possui um custo maior que $M, U$.
        A diferença de custos entre ambos será causada pela duplicação e deleção de alguns arcos de $M$.    
        Definimos como $C_+$ o custo dos arcos escolhidos para serem duplicados e $C_-$ o custo dos arcos deletados em $M'$.
        
        Como assumimos que $M', U'$ tem custo maior que $M, U$, deve valer:
        \begin{align*}
            2C_+ - C_- &> C_+ + C_- \\
            C_+ &> 2C_-
        \end{align*}
