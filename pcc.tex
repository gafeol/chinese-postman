...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[auto,node distance=3cm, every loop/.style={},thick,main node/.style={circle,draw,font=\sffamily\Large}]
            ...
            \path[->] (a) edge[line width=2,bend left=15] node [above] {5} (c);
            \path[->] (b) edge[] node [left] {3} (a);
            ...
            \path[every node/.style={font=\sffamily\small}]
                ...
                ;
        \end{tikzpicture}
        \caption{Em destaque os arcos adicionados pela função \ref{mixed-grau-total-par}}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[auto,node distance=3cm, every loop/.style={},thick,main node/.style={circle,draw,font=\sffamily\Large}]
            ...
            \path[every node/.style={font=\sffamily\small}]
                ...
                ;
        \end{tikzpicture}
        \caption{O arco $ba$ e a aresta orientada $cd$ foram duplicados pela função \ref{mixed-iguala-grau-dir}}
    ...
    No exemplo \ref{ex-grau-par} o algoritmo \ref{mixed-grau-par} toma o circuito $\{a, b, c, d, e, a\}$ para realizar a construção de $M', U'$ e tornar par o grau dos vértices do grafo. 
    ...
    Deste modo conseguem-se multiconjuntos $M', U'$ de mesmo custo que $M, U$ e que mantem $\gre = \grs$ e $\gr$ par para todo vértice de $G$.
    ...
    \begin{proof}
        ...
        Para exemplificar essa definição, na figura \ref{fig:mixed-ex-lema} mostram-se os conjuntos $M', U'$ e $M'', U''$ do exemplo tratado nesta seção.
    ...
    \begin{proof}
        ...
        Assim, como cada aresta e arco de $G$ é duplicado no máximo uma vez em $G'$, podemos afirmar que os multiconjuntos de arcos e arestas de $G'$ estarão contidos nos multiconjuntos de $G^*$ e por isso, o custo $C'$ da solução dada pelo algoritmo MIXED ao grafo $G$ deverá ser menor ou igual a $C^*$.
        ...
        Provando assim que o algoritmo MIXED é uma 0.5-aproximação para o problema do carteiro misto.
    \end{proof}
