...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \subsection{Problema do carteiro chinês com vento}
        ...
        \begin{figure}[H]
            ...
            \end{tikzpicture}
            \caption{Grafo $G$, cada aresta não direcionada foi representada por um par de arcos}
        \end{figure}

        Note que os dois circuitos dessa imagem possuem o mesmo circuito independente do sentido em que são percorridos:
