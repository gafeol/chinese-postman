...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \begin{lemma}
        Seja $C(M,U)$ o custo dos multiconjuntos $M,U$, ou seja, a soma do custo dos arcos e arestas que compõe $M$ e $U$.
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            \item Se uma aresta $e \in U$ foi orientada da forma $\langle u, v \rangle$ e adicionada a $M'$, a mesma será adicionada a $M''$ com a orientação oposta, $\langle v, u \rangle$.
        \end{enumerate}
    ...
    \begin{proof}
        Seja $G^*$ o grafo $G$ com todos arcos e arestas duplicadas e $C^*$ o custo da solução dada pelo algoritmo MIXED ao grafo $G^*$.
