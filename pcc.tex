...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    \Function{mixed}{G, c} 
        ...
        \State $M', U' \gets $AJUSTA\_PARIDADE$(G', M, U)$
        \State $G_e = (V, U', M')$
    ...
    \begin{algorithm}
    \floatname{algorithm}{Algoritmo}%
    \caption{Função auxiliar GRAU DIR}
    \label{mixed-grau-dir}
    \begin{algorithmic}[1]
    ...
    \begin{algorithm}
    \floatname{algorithm}{Algoritmo}%
    \caption{Função auxiliar AJUSTA PARIDADE}
    \label{mixed-ajusta-paridade}
    \begin{algorithmic}[1]
        \Function{ajusta\_paridade}{G, M, U}
            ...
            \While{$V'$ não é vazio}
                ...
                \While{$v \in V'$}
                    ...
                    \Repeat 
                        ...
                        \If{$a$ é o arco $vw$}
                            \State Insere uma cópia de $a$ em $M'$
                        \Else
