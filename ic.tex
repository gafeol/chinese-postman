...
%	Mathematische Annalen, 6 (1): 30–32, doi:10.1007/BF01442866, 1873.
    ...
    \bibitem{blossom}
    \href{https://en.wikipedia.org/wiki/Blossom_algorithm}{Algoritmo Blossom de Edmonds}

    \bibitem{kolmogorov}
    \href{http://pub.ist.ac.at/~vnk/papers/blossom5.pdf}{Paper de Vladimir Kolmogorov sobre o algoritmo ``Blossom V''}
