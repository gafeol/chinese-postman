...
\item[\textbf{4º}]  Um possível circuito eulerian $\mathcal{C}$ que se inicia no vértice $a$ é o seguinte:
    ...
    Assim como a variação do PCC para grafos mistos, o PCR é um problema NP-difícil.
    ...
    Para realizar a primeira parte da solução do problema, ou seja, criar uma estensão euleriana de $G$, serão apresentadas tanto heurísticas quanto discussões das soluções ótimas existentes.
