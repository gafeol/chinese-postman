...
Sendo assim, o grafo $G^*$ resultante é euleriano, e a solução para o PCC do grafo $G$ é o circuito euleriano de $G^*$.
    ...
    As sucessivas duplicações de caminho realizadas em $G$ fazem com que todos vértices do mesmo possuam grau de saída e entrada iguais, pelo teorema \ref{euler-digraph} temos que o novo grafo é euleriano. No quarto passo derivaremos um circuito euleriano do digrafo construído.
