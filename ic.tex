...
Sendo assim, o grafo $G^*$ resultante é euleriano, e a solução para o PCC do grafo $G$ é o circuito euleriano de $G^*$.
    ...
    \begin{proof}
        ...
        \begin{tcolorbox}
            ...
            Como $P$ é um passeio, possívelmente ele percorre um mesmo vértice mais que uma vez. Do contrário, já podemos considerar $P$ um caminho, finalizando o método. 
    ...
    \begin{itemize}
        ...
        \item[\textbf{2º}]
            ...
            Modelamos então o problema de transporte, os vértices $b, d, g$ escoando uma unidade de fluxo cada e os vértices $a, b$ com demandas de .
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[node distance=3cm, every loop/.style={},thick,main node/.style={circle,draw,font=\sffamily\Large}]
                    \node[main node] (1) {a};
                    \node (v1) at(-0.75, 0) {2};
                    \node[main node] at (0, -3) (2) {e};
                    \node (v2) at(-0.75, -3) {1};
                    \node[main node] at(2, 1.5) (3) {b};
                    \node (v3) at(2.75, 1.5) {1};
                    \node[main node] at(2, -1.5) (5) {d};
                    \node (v5) at(2.75, -1.5) {1};
                    \node[main node] (4) [below of=5] {g};
                    \node (v4) at(2.75, -4.5) {1};
                    \path[->] (1) edge  node[pos=0.25,above] {4} (3);
                    \path[->] (1) edge node[pos=0.10,left] {9} (4);
                    \path[->] (1) edge node[pos=0.25,above] {16} (5);
                    \path[->] (2) edge node[pos=0.10,above left] {6} (3);
                    \path[->] (2) edge node[pos=0.20,below] {5} (4);
                    \path[->] (2) edge node[pos=0.25,below] {11} (5);
                \end{tikzpicture}
            \end{figure}

            Os arcos definidos entre os vértices de $F$ e $S$ possuem capacidade infinita e custo igual a distância mínima dos mesmos vértices em $G$, como já calculado no primeiro passo.

            A solução ótima para o problema apresentado consiste em utilizar os arcos de custo $4, 5$ e $9$, escoando assim toda a demanda dos vértices $a$ e $e$.
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}[node distance=3cm, every loop/.style={},thick,main node/.style={circle,draw,font=\sffamily\Large}]
                    ...
                    \node[main node] (4) [below of=5] {g};
                    \node (v4) at(2.75, -4.5) {1};
                    \path[->] (1) edge[red]  node[pos=0.25,above] {4} (3);
                    \path[->] (1) edge[red] node[pos=0.10,left] {9} (4);
                    \path[->] (1) edge node[pos=0.25,above] {16} (5);
                    \path[->] (2) edge node[pos=0.10,above left] {6} (3);
                    \path[->] (2) edge node[pos=0.20,below] {5} (4);
                    \path[->] (2) edge[red] node[pos=0.25,below] {11} (5);
                \end{tikzpicture}
            \end{figure}
    \end{itemize}
