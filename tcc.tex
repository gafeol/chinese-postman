...
%
    ...
    Para encontrar tal valor, basta manter uma árvore de busca binária balanceada com as $k$ maiores recompensas dos valores disponíveis, o que custa tempo $\mathcal{O}(m\lg k) = \mathcal{O}(m\lg \sqrt{n})$.
        ...
        \hspace{.55cm} URL do problema: \href{https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1237}{https://onlinejudge.org/index.php?option=com\_onli\-ne\-judge\&Itemid\-=8\&page=show\_problem\&problem=1237}

        URL da solução: \href{https://github.com/gafeol/competitive-programming/blob/master/ojs/UVa/1237.cpp}{https://github.com/gafeol/compe\-titive-programming\-/blob/master/ojs/UVa/1237.cpp}
